...
from desafio_iafront.jobs.clusters.clusters import gaussian_mixtures_clustering, mean_shift_clustering
...
def mean_shift(dataset: str, saida: str, data_inicial, data_final):
    ...
    print(len(vector))
    labels = mean_shift_clustering(vector)
