...
from desafio_iafront.jobs.clusters.clusters import gaussian_mixtures_clustering, birch_clustering
...
def birch(dataset: str, number_of_cluster: int, saida: str, data_inicial, data_final):
    ...
    labels = birch_clustering(vector, number_of_cluster)
    print(labels)
